...
export default function Home() {
  ...
  const generateMIDI = async () => {
    ...
    try {
      ...
      // Call your actual backend endpoint (uses query params, not body)
        ...
        <div className="max-w-md mx-auto mb-8">
          <div className="bg-gray-900 p-6 rounded-lg border border-gray-800">
            ...
            <form onSubmit={isRegistering ? handleRegister : handleLogin} className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full py-3 bg-gradient-to-r from-blue-600 to-purple-600 hover:shadow-lg hover:shadow-blue-500/50 rounded-lg font-semibold transition-all"
              >
        ...
        <>
          ...
          {activeTab === 'complete' ? (
            ...
            <div className="max-w-4xl mx-auto space-y-6">
              ...
              {/* Audio Preview with Real Audio Playback */}
              {currentMidiUrl && (
                <MidiPlayerWithAudio
